<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%--
    	...
    	2. 동일점은 생성시에는 request로 생성
    		request.getCookie()
    		request.getSession()
    	3. 저장 => cookie (문자열만 저장), session(Object 저장)
    	4. 동일점 : Map 형식(키, 값) ==> 키가 동일하면 덮어쓴다
    	...
    	Cookie
    		...
    		6. 삭제
    			cookie.setMaxAge(0)
    		7. 사용처 => 최근 방문, 장바구니, 자동로그인
    			로그인 (스프링) => 암호화, 복호화, 자동로그인, ID 저장
