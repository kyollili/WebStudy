...
<%
	...
	//3. 출력 => HTML
	// *** 데이터를 자바에서 읽은 다음 출력 (자바는 데이터 관리) => HTML은 가지고 온 데이터를 출력만 한다 (정적페이지) => JSP(동적페이지)
	// 총페이지 받기
	int totalpage=(int)(Math.ceil(dao.databoardRowCount()/10.0));
	int count=dao.databoardRowCount(); //슷지 일정하게 배치
...
<body>
	<div class="row row1">
		...
		<table class="table">
			<tr>
				<td>
					<a href="../main/main.jsp?mode=7" class="btm btm-sm btn-danger">새 글</a>
				</td>
			</tr>
		</table>
		<table class="table">
