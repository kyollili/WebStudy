...
<%-- 제어문: core, 변환:fmt, String메소드: fn --%>
<%--
   JSP에서 처리 => Model로 따로 처리가 가능하게 만든다 (장점: 보안, 확장성, 재사용성 좋음)
...
<%
   ...
   //JSP마다 request를 가지고 있다 ==> request를 전송하고 직접 값을 받아온다
%>
<!DOCTYPE html>
<html>
<head>
        ...
        <tr>
          <td>
            ...
            <c:forEach var="vo" items="${list }">
              <table class="table">
                <tr>
                  <td class="texxt-center" width=30% rowspan="4">
