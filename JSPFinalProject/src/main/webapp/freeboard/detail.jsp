  ...
  <table class="table">
   ...
   <tr>
     <td class="text-right" colspan="4">
       ...
       <span class="btn btn-sm btn-warning" id="delete">삭제</span>
       <a href="../freeboard/list.do" class="btn btn-sm btn-info">목록</a>
     </td>
   </tr>
      ...
      <tr>
        <td>
          <form method="post" action="../freeboard/reply_insert.do">
           <input type=hidden name="bno" value="${vo.no }">
            <textarea rows="4" cols="98" name="msg" style="float:left"></textarea>&nbsp;
            <input type=submit value="댓글쓰기" class="btn btn-sm btn-danger" style="height: 82px">
          </form>
        </td>
      </tr>
    </table>
